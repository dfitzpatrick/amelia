...
from .data import AllowedChannel
...
class MetarConfigGroup(app_commands.Group):
    ...
    COMMAND_NAME = 'observation'
    def __init__(self, bot: 'AmeliaBot'):
        super().__init__(name=self.COMMAND_NAME, description='Configuration commands for METAR functionality')
        self.bot = bot
...
class TafConfigGroup(app_commands.Group):
    COMMAND_NAME = 'taf'
    def __init__(self, bot: 'AmeliaBot'):
        super().__init__(name=self.COMMAND_NAME, description='Configuration commands for TAF functionality')
        self.bot = bot
